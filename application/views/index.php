...
<main>
    ...
    <div class="slider-area ">
        <div class="slider-active">
            <div class="single-slider slider-height d-flex align-items-center" data-background="assets/img/hero/SCENE.svg">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        <div class="col-lg-7 col-md-9 ">
                            <div class="hero__caption">
                                <h1 data-animation="fadeInLeft" data-delay=".4s">Aplikasi <br> Penyedia Beasiswa</h1>
                                <p data-animation="fadeInLeft" data-delay=".6s">Aplikasi penyedia beasiswa ini merupakan aplikasi yang menyediakan beberapa beasiswa yang tersedia dilingkungan kampus Universitas Langlangbuana</p>
                                <!-- Hero-btn -->
                        ...
                        <div class="col-lg-5">
                            <div class="hero__img d-none d-lg-block" data-animation="fadeInRight" data-delay="1s">
                                <img src="<?= base_url() ?>assets/landing/img/hero/heros.svg" width="2500px" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <!-- <div class="single-slider slider-height d-flex align-items-center" data-background="assets/img/hero/h1_hero.png">
                <div class="container">
                    <div class="row d-flex align-items-center">
                        ...
                        <div class="col-lg-5">
                            <div class="hero__img d-none d-lg-block" data-animation="fadeInRight" data-delay="1s">
                                <img src="<?= base_url() ?>assets/landing/img/hero/hero_right.png" alt="">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row d-flex align-items-end">
                <div class="col-lg-6 col-md-12">
                    <div class="we-create-img">
                        <img src="<?= base_url() ?>assets/landing/img//service/we-create.png" alt="">
                    </div>
                </div>
                <div class="col-lg-6 col-md-12">
        ...
        <div class="container">
                ...
                <div class="col-lg-8">
                    <div class="section-tittle text-center">
                        <h2>Tahapan Bergabung Beasiswa​​</h2>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single-generating d-flex mb-30">
                        ...
                        <div class="generating-cap">
                            <h4>Tahap Pertama</h4>
                            <p>Lakukan pendaftaran pada button yang disediakan. atau login apabila sudah memiliki akun.</p>
                        </div>
                    </div>
                </div> 
                <div class="col-lg-6 col-md-6">
                    <div class="single-generating d-flex mb-30">
                        ...
                        <div class="generating-cap">
                            <h4>Tahap Kedua</h4>
                            <p>Isi informasi pribadi secara lengkap dan persyaratan umum pada dashboard anda ketika setelah login.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single-generating d-flex mb-30">
                        ...
                        <div class="generating-cap">
                            <h4>Tahap Ketiga</h4>
                            <p>Masuk ke menu Beasiswa, download berkas persyaratan tiap beasiswa agar tahu lebih detail tentang beasiswa tersebut</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single-generating d-flex mb-30">
                        ...
                        <div class="generating-cap">
                            <h4>Tahap Keempat</h4>
                            <p>Klik tombol <b> 'Gabung' </b> pada beasiswa yang sudah anda rasa cocok untuk memenuhi syarat dan ketentuannya.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
                    <div class="single-generating d-flex mb-30">
                        ...
                        <div class="generating-cap">
                            <h4>Tahap Kelima</h4>
                            <p>Tunggu notifikasi dari kami perihal hasil kelolosan anda pada beasiswa yang anda pilih.</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6">
