                ...
                <div class="single-footer-caption mb-50">
                  <div class="single-footer-caption mb-30">
                      ...
                      <div class="footer-logo">
                          <a href="index.html"><img src="<?= base_url() ?>assets/landing/img/logo/logoo.png" width="200px" alt=""></a>
                      </div>
                      <div class="footer-tittle">
                          <div class="footer-pera">
                              <p class="info1">Jalan Karapitan No 116, Universitas Langlangbuana <br> Bandung, 40256</p>
...
<!-- JS here -->
 ...
 <script src="<?= base_url() ?>assets/landing//js/vendor/modernizr-3.5.0.min.js"></script>
 ...
 <!-- Jquery Mobile Menu -->
 <script src="<?= base_url() ?>assets/landing//js/jquery.slicknav.min.js"></script>
 ...
 <script src="<?= base_url() ?>assets/landing//js/animated.headline.js"></script>
 ...
 <script src="<?= base_url() ?>assets/landing//js/jquery.form.js"></script>
