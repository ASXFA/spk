    ...
    <div class="row justify-content-center">
      ...
      <?php 
        ...
        <script>
          ...
          Toast.fire({
              icon: 'error',
              title: 'Login Gagal ! , <?= $this->session->flashdata('pesan') ?>'
          });
        </script>
        <?php
            }
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form action="<?= base_url('auth/0') ?>" class="user" method="post">
                    ...
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user" name="pass" id="exampleInputPassword" placeholder="Masukan Password ...">
                    </div>
                    <div class="form-group">
